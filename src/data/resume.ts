export const resume = {
  ...
  socials: {
    ...
    github: 'https://github.com/WesleyAlvesDS',
  },
  ...
  experience: [
    ...
    },
    {
      ...
      type: 'work',
      description:
        'Gestão de Loja e Estoque (Liderança de Equipe); Resolução de Problemas (Colaboradores e Clientes); Atendimento ao Cliente e Conexões Inteligentes.',
    },
    {
      role: 'Auxiliar Administrativo',
      company: 'Caritas Diocesana de Crateús — CE',
      period: '2020',
      type: 'work',
      description:
        'ETL, gestão de planilhas eletrônicas; organização e manutenção de pastas documentais com armazenamento na nuvem; atendimento ao público; auxílio à diretoria; suporte às equipes de planejamento e projetos.',
    },
  ],
  ...
  mindmap: {
    ...
    branches: [
      ...
      },
      {
        label: 'Soft Skills',
        color: '#3b82f6',
        items: ['Liderança', 'Atendimento ao Cliente', 'Gestão de Equipes', 'Resolução de Problemas'],
      },
    ],
  },
};
